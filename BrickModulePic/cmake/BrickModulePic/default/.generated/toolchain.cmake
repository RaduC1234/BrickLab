...
set(MP_CC_DIR "D:/Microchip/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the compiler base directory")
set(CMAKE_C_COMPILER "D:/Microchip/bin/xc8-cc.exe" CACHE FILEPATH "Path to the compiler binary")
...
set(CMAKE_ASM_COMPILER "D:/Microchip/bin/xc8-cc.exe" CACHE FILEPATH "Path to the compiler binary.")

# Legacy variable from MPLAB X pointing to the assembler binary.
set(MP_AS ${CMAKE_ASM_COMPILER})

set(MP_LD "D:/Microchip/bin/xc8-cc.exe" CACHE FILEPATH "Legacy variable from MPLAB X pointing to the linker binary.")

set(MP_AR "D:/Microchip/bin/xc8-ar.exe" CACHE FILEPATH "Legacy variable from MPLAB X pointing to the archiver binary.")

set(CMAKE_AR "D:/Microchip/bin/xc8-ar.exe" CACHE FILEPATH "Path to the archiver binary.")
